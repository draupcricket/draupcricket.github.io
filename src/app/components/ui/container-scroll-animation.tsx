...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[35rem] md:h-[60rem] flex items-center justify-center relative p-2 md:px-20 md:py-0 max-sm:pt-0"
      ref={containerRef}
    >
      <div
        className="py-6 md:py-0 w-full relative max-sm:pt-0"
        style={{
          perspective: "1000px",
        }}
      >
  ...
  export const FallbackImage = ({
    ...
    return (
      <motion.div
        ...
        className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-6 bg-[#222222] rounded-[30px] shadow-2xl"
      >
       <img src="/Draup_Banner.jpg" alt="Draup Cricket" className="w-full object-cover mx-auto h-[25rem] md:h-[35rem]" />
      </motion.div>
    );
  };